                        ...
                        >
                            ...
                            {user.isAuthenticated && (
                                <div className="d-lg-flex d-md-flex justify-content-lg-end justify-content-md-center">
                                    <div
                                        className="d-flex justify-content-evenly align-items-center me-auto mb-2 mb-md-0 mb-lg-0"
                                        style={{
                                    ...
                                    <div
                                        className="d-flex justify-content-evenly align-items-center me-auto mb-2 mb-lg-0"
                                        style={{
                                            fontFamily: 'Arial, sans-serif',
                                            height: '5vh',
                                            padding: '1vh',
