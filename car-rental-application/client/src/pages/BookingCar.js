...
export const BookingCar = (abc) => {
    ...
    const bookCar = async (reqObj) => {
        try {
            ...
            const response = await axios.post(
                `${backendUrl}/api/bookings/bookcar`,
                reqObj
            );
            if (response) {
    ...
    return (
        <div>
            <DefaultLayout>
                {isLoading && (
                    <div className="d-flex justify-content-lg-center justify-content-center justify-content-md-center justify-content-sm-center align-items-center align-items-lg-center">
                        <Spinner />
                    </div>
                )}
                {car && (
                    <div className="">
                        <div className="row d-lg-flex d-md-flex d-sm-flex">
                            <div
                                className="d-flex col-lg-10 col-md-10 col-sm-12 col-12  justify-content-lg-center justify-content-md-center justify-content-sm-center justify-content-center align-content-lg-center align-content-md-center align-content-sm-center align-content-center"
                                style={{ height: '25vh' }}
                            >
                                <img
                                    alt="carimage"
                            ...
                            >
                                <div
                                    className="text-capitalize text-center text-lg-center text-md-center text-sm-center"
                                    style={{ maxHeight: '100%' }}
                                >
