              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                  />
                  {error ==="Username" && <p style={{ color: 'red' }}>Username is Taken</p>}
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                  />
                  {error ==="Email" && <p style={{ color: 'red' }}>Email is Taken</p>}
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                  />
                  {error ==="Password" && <p style={{ color: 'red' }}>Password Mismatch!!</p>}
                </div>
