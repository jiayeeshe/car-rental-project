...
export const Insert = () => {
  ...
  return (
    ...
    <div className='container-lg container-md container-sm container shadow' style={{maxWidth:"100%"}}>
      <div className='d-lg-flex d-md-flex d-sm-flex d-flex justify-content-lg-center justify-content-md-center justify-content-sm-center justify-content-center m-auto m-lg-auto m-md-auto m-sm-auto'style={{maxWidth:"100%"}}>
      <img src={carImage? carImage: emptyImage} className='carimg'  />
      </div>
